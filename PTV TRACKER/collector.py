...
DATA_FILE = '/app/data/ptv_delays.csv'
LOG_FILE  = '/app/data/collection_log.txt'
...
@app.route('/download')
def download():
    return send_file('/app/data/ptv_delays.csv', as_attachment=True)
...
if __name__ == '__main__':
    ...
    schedule.every(15).minutes.do(collect_snapshot)
    print("Scheduler running — collecting every 15 minutes.")
